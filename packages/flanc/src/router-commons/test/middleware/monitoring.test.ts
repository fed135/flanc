import { generateExpressRequest } from '../../../../test/express-utils';
import monitoring from '../../middleware/monitoring';
import { modules } from '../../../../monitoring';

let setControllerNameMock;

describe.skip('[Packages | Router | JSON-API] interacting with the json api monitoring tools', () => {
  beforeEach(() => {
    setControllerNameMock = jest.spyOn(modules, 'setControllerName').mockReturnValue(true);
  });
